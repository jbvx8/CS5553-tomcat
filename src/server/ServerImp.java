...
public class ServerImp implements IServerImp
{
	...
	*/	
	public void init(){
        ...
        Response.setArch(_arch);
        ContextConfig.setArch(_arch);
        HostConfig.setArch(_arch);
        Tomcat.setArch(_arch);
        RewriteValve.setArch(_arch);
        AbstractSingleArchiveResourceSet.setArch(_arch);
        JarWarResource.setArch(_arch);
        JarWarResourceSet.setArch(_arch);
        StandardRoot.BaseLocation.setArch(_arch);
        WarResource.setArch(_arch);
        WarURLConnection.setArch(_arch);
        JarFactory.setArch(_arch);
        StandardJarScanner.setArch(_arch);
	}
	public void begin(){
